...
const Speaker:NextPage<Props> = ({speakerName}) => {
 ...
 <div className="container mx-auto">
     <div className="flex flex-col mb-5">
         <div className="w-full" style={{background: '#eee', height: '420px'}}></div>
         <div className="flex flex-row">
            <div className="">
                <img className="h-48 w-48 -my-24 mx-10 rounded-full border-white border-8" src="https://images.unsplash.com/photo-1478172326435-839f111a16c5" />
            </div>
            <div className="">
     ...
     <div className="flex flex-row">
         ...
         <div className="w-3/5">
            ...
            <div className="p-5 shadow-lg">
                ...
                <p>ng-Conf 2020</p>
                <div>
                <iframe className="w-full" height="420px" src="https://www.youtube.com/embed/ySDX02WD0og" frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
                </div>
            </div>
            </div>
            <div className="mb-5">
                ...
                <div className="w-2/3">
                    ...
                    <div className="bg-cover bg-center w-1/3 rounded-tr-md" style={{backgroundImage: "url(" + "https://images.unsplash.com/photo-1478172326435-839f111a16c5" + ")"}}>      
                    </div>
         ...
         <div className="w-1/5">
            <h2 className="px-3 text-2xl font-semibold mb-5">Technologies</h2>
             ...
             <a className="rounded-full text-sm py-1 px-3 mr-2 my-2 bg-red-500 text-white">Angular</a>
             <a className="rounded-full text-sm py-1 px-3 mr-2 my-2 bg-yellow-500 text-white">JavaScript</a>
             <a className="rounded-full text-sm py-1 px-3 mr-2 my-2 bg-green-500 text-white">MongoDB</a>
             <a className="rounded-full text-sm py-1 px-3 mr-2 my-2 bg-green-300 text-white">Vue</a>
             </div>
         </div>
     </div>
